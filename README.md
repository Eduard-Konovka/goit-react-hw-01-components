...
![Превью компонента Profile](https://github.com/goitacademy/react-homework/blob/master/homework-01/social-profile/preview.png)
...
в файле
[statistical-data.json](https://github.com/goitacademy/react-homework/blob/master/homework-01/statistics/statistical-data.json).

![Превью компонента Statistics](https://github.com/goitacademy/react-homework/blob/master/homework-01/statistics/preview.jpg)
...
файле
[friends.json](https://github.com/goitacademy/react-homework/blob/master/homework-01/friend-list/friends.json).

![Превью компонента FriendList](https://github.com/goitacademy/react-homework/blob/master/homework-01/friend-list/preview.jpg)
...
![Превью компонента TransactionHistory](https://github.com/goitacademy/react-homework/blob/master/homework-01/transaction-history/preview.jpg)

Данные для списка доступны в формате JSON в файле
[transactions.json](https://github.com/goitacademy/react-homework/blob/master/homework-01/transaction-history/transactions.json).
